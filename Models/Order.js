...
/**
 * Phlebo booking / order — MongoDB collection: `orders`.
...
const orderSchema = new mongoose.Schema(
  {
     ...
     *  the dashboard. Cleared back to "" whenever the order goes unassigned. */
    assignedBy: {
      type: String,
    ...
    samples: [
      {
         ...
         *  /admin/orders/:id/samples/:barcode/reject, jo optionally ek redraw order bhi
         *  bana deta hai. */
    ...
    redrawOf: { type: mongoose.Schema.Types.ObjectId, ref: "Order", default: null },
    ...
    // Walk-in patient added by phlebo at another order's address
    walkInSourceJobId: { type: mongoose.Schema.Types.ObjectId, ref: "Order", default: null },
    /**
     * Kaunsi channel se order bani:
